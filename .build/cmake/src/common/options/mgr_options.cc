...
std::vector<Option> get_mgr_options() {
  return std::vector<Option>({
    ...
    Option("mgr_max_pg_creating", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_description("bound on max creating pgs when acting to create more pgs")
    .set_default(1024)
    .add_service("mgr"),

    Option("mgr_module_path", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_description("Filesystem path to manager modules.")
    .set_default("C:/Program Files (x86)/ceph/share/ceph/mgr")
    .add_service("mgr"),
    ...
    Option("mon_warn_on_pool_no_app_grace", Option::TYPE_SECS, Option::LEVEL_DEV)
    .set_description("time after which POOL_APP_NOT_ENABLED health warning is issued")
    .set_default(5_min)
    .add_service("mgr")
    .add_see_also({"mon_warn_on_pool_no_app"}),
