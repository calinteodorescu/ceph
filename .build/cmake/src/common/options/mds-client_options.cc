...
std::vector<Option> get_mds_client_options() {
  return std::vector<Option>({
    ...
    Option("client_debug_inject_features", Option::TYPE_STR, Option::LEVEL_DEV)
    ...
    Option("client_file_blockdiff_max_concurrent_object_scans", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
