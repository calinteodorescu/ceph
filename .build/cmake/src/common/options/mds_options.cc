...
std::vector<Option> get_mds_options() {
  return std::vector<Option>({
    ...
    Option("mds_cache_quiesce_delay", Option::TYPE_MILLISECS, Option::LEVEL_DEV)
    .set_description("delay before starting recursive quiesce inode operations")
    .set_default(0)
    .set_flag(Option::FLAG_RUNTIME)
    .add_service("mds"),

    Option("mds_cache_quiesce_splitauth", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_description("allow recursive quiesce across auth boundaries")
    .set_default(true)
    .set_flag(Option::FLAG_RUNTIME)
    .add_service("mds"),
    ...
    Option("mds_cache_quiesce_decay_rate", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_description("decay rate for quiescing inodes throttle")
    .set_default(1.0)
    .set_flag(Option::FLAG_RUNTIME)
    .add_service("mds"),

    Option("mds_cache_quiesce_threshold", Option::TYPE_SIZE, Option::LEVEL_ADVANCED)
    .set_description("threshold for number of inodes that can be quiesced")
    .set_default(512_K)
    .set_flag(Option::FLAG_RUNTIME)
    .add_service("mds"),

    Option("mds_cache_quiesce_sleep", Option::TYPE_MILLISECS, Option::LEVEL_ADVANCED)
    .set_description("sleep time for request after passing quiesce threshold")
    .set_default(200)
    .set_flag(Option::FLAG_RUNTIME)
    .add_service("mds"),
    ...
    Option("mds_allow_async_dirops", Option::TYPE_BOOL, Option::LEVEL_ADVANCED)
    .set_default(true)
    .add_service("mds"),
    ...
    Option("mds_kill_after_journal_logs_flushed", Option::TYPE_BOOL, Option::LEVEL_DEV)
    .set_default(false)
    .add_service("mds"),
    ...
    Option("mds_scrub_stats_review_period", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_description("Period for which scrub stats will be available for review.")
    .set_long_description("Number of days for which scrub stats will be available for review since start of scrub operation. After this period, the stats will be auto purged. These stats will not be saved to the disk. So any restart or failover of mds will cause stats to be lost forever.")
    .set_default(1)
    .set_min_max(1, 60),
    ...
    Option("mds_log_trim_threshold", Option::TYPE_SIZE, Option::LEVEL_ADVANCED)
    .set_description("MDS log trim threshold")
    .set_long_description("The threshold of the number of log segment that can be trimmed.")
    .set_default(128)
    .set_min(1)
    .set_flag(Option::FLAG_RUNTIME)
    .add_service("mds")
    .add_see_also({"mds_log_max_events", "mds_log_max_segments"}),

    Option("mds_log_trim_decay_rate", Option::TYPE_FLOAT, Option::LEVEL_ADVANCED)
    .set_description("MDS log trim decay rate")
    .set_long_description("The decay rate for trimming the MDS log. Increasing this value leads to the MDS spending less time in trimming the log.")
    .set_default(1.0)
    .set_min(0.01)
    .set_flag(Option::FLAG_RUNTIME)
    .add_service("mds")
    ...
    Option("mds_log_trim_upkeep_interval", Option::TYPE_MILLISECS, Option::LEVEL_ADVANCED)
    .set_description("MDS log trimming interval")
    .set_long_description("Interval in milliseconds to trim MDS logs.")
    .set_default(1000)
    .add_service("mds"),

    Option("mds_delay_journal_replay_for_testing", Option::TYPE_MILLISECS, Option::LEVEL_DEV)
    .set_description("Delay the journal replay to verify the replay time estimate")
    .set_long_description("Jorunal replay warning is activated if the mds has been in replay state for more than 30 seconds. This config delays replay for validating the replay warning in tests.")
    .set_default(0)
    .set_flag(Option::FLAG_RUNTIME),

    Option("mds_server_dispatch_killpoint_random", Option::TYPE_FLOAT, Option::LEVEL_DEV)
    .set_default(0.0)
    .set_flag(Option::FLAG_RUNTIME)
    .add_service("mds"),

    Option("mds_server_dispatch_client_request_delay", Option::TYPE_MILLISECS, Option::LEVEL_DEV)
    .set_default(0)
    .set_flag(Option::FLAG_RUNTIME)
    .add_service("mds"),

    Option("mds_log_minor_segments_per_major_segment", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_description("number of minor segments per major segment.")
    .set_long_description("The number of minor mds log segments since last major segment after which a major segment is started/logged.")
    .set_default(16)
    .set_min(4)
    .add_service("mds"),

    Option("mds_file_blockdiff_max_concurrent_object_scans", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
    .set_description("maximum number of concurrent object scans")
    .set_long_description("Maximum number of concurrent listsnaps operations sent to RADOS.")
    .set_default(16)
    .set_min(1)
    .add_service("mds"),
