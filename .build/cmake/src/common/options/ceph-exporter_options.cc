...
std::vector<Option> get_ceph_exporter_options() {
  return std::vector<Option>({
    ...
    Option("exporter_cert_file", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_description("Certificate file for TLS.")
    .add_service("ceph-exporter"),

    Option("exporter_key_file", Option::TYPE_STR, Option::LEVEL_ADVANCED)
    .set_description("Key certificate file for TLS.")
    .add_service("ceph-exporter"),
